            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-warning">
                        Selamat datang <b><?php echo $mahasiswa->mhs_nama; ?></b>,Sistem Informasi Pendaftaran UKM Politeknik Pos Indonesia
                    </div>
                       <!-- ========== Flashdata ========== -->
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <div class="dashboard-div-wrapper bk-clr-three">
                        ...
                        <div class="progress progress-striped active">
                         ...
                         <?php } }  ?>   
                              <a class="btn btn-warning btn-ls" data-toggle="modal" data-target="#myModal<?php echo $row1->ukm_id;?>">
                              Detail UKM
                            </a>
                    </div>  
                    </form>
